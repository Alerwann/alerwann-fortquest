...
private quests: Quest[]=[
  {
    date : 'semaine 0',
    type: 'semaine',
    linkytb: 'https://youtu.be/4UX7rbwlFJE?si=eYyoEFaW0htgC0Fh',
  ...
  },
  {
    ...
    type: 'recit',
    linkytb: 'https://youtu.be/nToAB8wf7-s?si=WCxyatzMSpHMsl7l',
  ...
  },
  {
    date : 'semaine 1',
    type: 'semaine',
    linkytb: 'https://youtu.be/81TG28_z_j4?si=u8URDirReaZhRkui',
